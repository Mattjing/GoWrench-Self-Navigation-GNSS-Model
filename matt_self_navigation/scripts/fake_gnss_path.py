...
def get_route_coordinates(api_key, origin, destination, mode):
...
def fake_gnss_publisher(api_key, origin, destination, mode):
    ...
    coordinates = get_route_coordinates(api_key, origin, destination, mode)
...
if __name__ == '__main__':
    ...
    origin = "200 Longwood Rd S, Hamilton, ON L8P 0A6"
    destination = "1280 Main St W, Hamilton, ON L8S 4L8"
    mode = 'walking'
